...
const Cake = () => {
    ...
    return (
        <>
            ...
            <Text position={[0, 1.5, 0]} fontSize={0.32} fontWeight={300} color="black" anchorX="center" anchorY="middle">
                Happy Birthday for me!
            </Text>
            <Text position={[0, 1.13, 0]} fontWeight={100} fontSize={0.25} color="black" anchorX="center" anchorY="middle">
